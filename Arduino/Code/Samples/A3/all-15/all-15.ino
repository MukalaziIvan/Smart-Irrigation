    ...
    void loop() {
      ...
      char* CropType = 'Coffee';
      float SoilMoisture = mappedSoilMoistureValue
      float CropDays = 15;
      //make a list of the features of the data to be predicted by the model ie temperature, croptype, soilMoisture, cropdays 
      x['CropType'] = x['CropType'].replace({'Wheat':0, 'Groundnuts':1, 'Garden Flowers':2, 'Maize':3, 'Paddy':4,
        'Potato':5, 'Pulse':6, 'Sugarcane':7, 'Coffee':8})
      //using an imported scaler to scale down the sensor data
